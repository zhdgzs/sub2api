#!/usr/bin/env python3
"""Update docs/DOCKER_RELEASE_HISTORY.md from custom release commits."""
...
def update_release_record(repo: Path, version: str, release_date: str, rev: str) -> tuple[bool, str]:
    ...
    changes = custom_release_changes(repo, rev)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Update Docker release history from custom commits")
