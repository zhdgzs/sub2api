...
// compareVersions compares the three numeric components of two semantic versions.
// The fork release suffix identifies a downstream build of the same upstream version.
