...
const planTypeOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlanTypes') }, { value: 'free', label: 'Free' }, { value: 'plus', label: 'Plus' }, { value: 'team', label: 'Team' }, { value: 'pro', label: 'Pro' }])
