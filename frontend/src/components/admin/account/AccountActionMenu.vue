...
const emit = defineEmits(['close', 'test', 'stats', 'copy-access-token', 'export-account', 'schedule', 'reauth', 'refresh-token', 'recover-state', 'reset-quota', 'set-privacy', 'create-spark-shadow'])
const { t } = useI18n()
