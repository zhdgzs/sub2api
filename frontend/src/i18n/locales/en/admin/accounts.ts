export default {
    accounts: {
      ...
      quotaPrediction: 'Predicted quota',
      ...
      quotaHistoryUsedPercent: 'Usage ratio',
      quotaHistoryStartShort: 'Start',
      quotaHistoryEndShort: 'End',
      quotaHistoryEmpty: 'No quota periods recorded',
      quotaHistoryCurrent: 'In progress',
      quotaHistoryNoPrediction: 'No prediction',
      quotaHistoryLoadFailed: 'Failed to load quota history',
      quotaHistoryRetry: 'Retry',
      quotaHistoryPage: 'Page {page} of {pages}',
      quotaHistoryOlder: 'Older',
      quotaHistoryNewer: 'Newer',
      openaiQuotaReset: {
        count: 'Credits',
        reset: 'Reset',
