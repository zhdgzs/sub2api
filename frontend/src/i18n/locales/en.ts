export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      keywordBlockingMode: 'Keyword/API Strategy',
      ...
      localRules: {
        enabled: 'Enable Local Prompt Rules',
        enabledHint: 'Migrates codex2api regex scoring rules. Defaults to record-only with side effects controlled separately.',
        action: 'Action on Hit',
        actionRecord: 'Record only',
        actionRecordDesc: 'Write an audit log, then continue or skip OpenAI Moderations API according to config.',
        actionBlock: 'Block request',
        actionBlockDesc: 'Reject hits in pre-block mode; observe mode still records only.',
        scanScope: 'Scan Scope',
        scanLatestUserInput: 'Latest user input',
        scanLatestUserInputDesc: 'Reuses the current risk-control input extractor. This is the conservative default.',
        scanFullTextContext: 'Full text context',
        scanFullTextContextDesc: 'Scans instructions, messages, prompt, input, and related text while skipping base64, URLs, and file fields.',
        threshold: 'Threshold',
        strictThreshold: 'Strict threshold',
        maxTextLength: 'Max scan length',
        skipApiAfterHit: 'Skip API after hit',
        skipApiAfterHitHint: 'When enabled, local hits that are not blocked skip OpenAI Moderations API.',
        countForAutoBan: 'Count for auto-ban',
        countForAutoBanHint: 'When enabled, local hits enter the existing auto-ban rolling window.',
        recordHash: 'Record risk hash',
        recordHashHint: 'When enabled, local hits write into the Redis risk-hash set.',
        emailOnHit: 'Send hit email',
        emailOnHitHint: 'When enabled, local hits reuse content-moderation email notifications.',
        builtinRules: 'Built-in Rules',
        builtinRulesHint: 'codex2api cyber abuse rules. Disable individual rules to reduce false positives.',
        builtinRuleCount: '{count} rules',
        ruleName: 'Rule name',
        category: 'Category',
        weight: 'Weight',
        ...
        customRulesHint: 'Supplement built-in rules. Regex patterns are validated by the backend on save.',
        addCustomRule: 'Add rule',
        customRulesEmpty: 'No custom rules yet',
        testTitle: 'Rule Test',
        testHint: 'Tests local rules only. It does not write logs, call OpenAI Moderations API, ban users, or send email.',
        testButton: 'Test rules',
        testing: 'Testing',
        testPlaceholder: 'Enter a prompt to test local rules',
        testHit: 'Local rule hit',
        testPass: 'No hit',
        testScore: 'score {score} / raw {raw} / strict {strict}',
        testFailed: 'Failed to test local rules',
        logDetail: 'Local Rule Detail',
        logSummary: '{category} · score {score} · {matches}',
        keywordOnlyNotice: 'Keyword-only strategy: OpenAI Moderations API is not on this path, and local rules will not re-enable API calls.',
        apiOnlyNotice: 'API-only strategy: the keyword list is disabled; local Prompt rules are controlled independently here.',
      },
      overview: {
        status: 'Status',
        enabled: 'Enabled',
      ...
      action: {
        ...
        localRuleHit: 'Local Rule Hit',
        localRuleBlock: 'Local Rule Blocked',
    ...
    accounts: {
      ...
      dataExportAccount: 'Export this account',
      dataExportIncludeProxies: 'Include proxies linked to the exported accounts',
      dataImport: 'Import',
      copyAccessToken: 'Copy access_token',
      accessTokenCopied: 'access_token copied',
      accessTokenNotFound: 'No access_token found',
      copyAccessTokenFailed: 'Failed to copy access_token',
      ...
      selectTestPrompt: 'Select test prompt',
      testModel: 'Test model',
      testPrompt: 'Prompt: "{prompt}"',
      testPromptIdentity: 'Model identity',
      testPromptHi: 'hi',
      testPromptBubbleSort: 'Python bubble sort',
      testPromptCustom: 'Custom',
      customTestPromptLabel: 'Custom prompt',
      customTestPromptPlaceholder: 'Enter the prompt to send for this connection test',
      customTestPromptRequired: 'Enter a custom prompt',
