export default {
    accounts: {
      ...
      quotaHistoryUsedPercent: '使用比例',
      quotaHistoryStartShort: '始',
      quotaHistoryEndShort: '止',
      quotaHistoryEmpty: '暂无额度周期记录',
      quotaHistoryCurrent: '进行中',
      quotaHistoryNoPrediction: '暂无预测',
      quotaHistoryLoadFailed: '额度历史加载失败',
      quotaHistoryRetry: '重试',
      quotaHistoryPage: '第 {page} / {pages} 页',
      quotaHistoryOlder: '更早',
      quotaHistoryNewer: '更新',
      openaiQuotaReset: {
        count: '次数',
        reset: '重置',
